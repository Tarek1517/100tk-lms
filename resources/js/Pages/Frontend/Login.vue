            ...
            <div class="w-[90%] max-w-4xl bg-white flex flex-wrap rounded-xl shadow-xl p-4">
                <div class="w-full lg:w-1/2 lg:pr-5 lg:pt-10">
                    ...
                    <div class="text-center py-5">
                        <button  class="w-full py-2 bg-primary text-white font-bold text-center rounded-lg my-2">Log In</button>
                    </div>
                    <p>Don't have an account <Link href="/register" class="text-primary">Create Account</Link>.</p>
                </div>
                <div class="hidden lg:block w-1/2">
                    <img class="w-full h-96 object-cover rounded-xl" src="https://i.pinimg.com/564x/7b/3f/e1/7b3fe1e66e263b7e0c0e1f1cfb4086c7.jpg">
                </div>
            </div>
        </div>
    </AppLayout>
