...
const form = useForm({
    _method: "put",
    title: props.editCourse.title || "",
    cover_image: null,
    imagePreview: props.editCourse.cover_image
        ? `/storage/img/${props.editCourse.cover_image}`
        : null,
    short_description: props.editCourse.short_description || "",
    description: props.editCourse.description || "",
    price: props.editCourse.price || "",
    category_id: props.editCourse.category_id || "",
});
