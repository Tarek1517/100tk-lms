    ...
    <div class="fixed top-0 bg-white left-0 right-0 z-50 border-b shadow-lg">
        <div class="flex items-center justify-between py-3 px-12">
            ...
            <div class="flex gap-3">
                <span
                    class="bg-primary size-9 rounded-full flex items-center justify-center"
                >
                    <Icon
                        name="icon-park-solid:people-right"
                ...
                <ul>
                    ...
                    <li class="text-xs text-primary font-medium">Student</li>
                </ul>
            </div>
        </div>
    </div>
